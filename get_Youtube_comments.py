...
##https://medium.com/towards-data-science/how-to-build-your-own-dataset-of-youtube-comments-39a1e57aade
...
key = 'AIzaSyDYd3aKrwZoVn-DVaGMevHjgjtcGi44WdQ'
channelId = 'UCh08-hL8TAzyve9diCTcgiQ'
...
def get_comments(part='snippet', 
                 ...
                 csv_filename="donaldson_comments"
                 ):
    ...
    #build our service to store desired information
...
if __name__ == '__main__':
    donaldson_comments = get_comments()
    df = pd.DataFrame(donaldson_comments)
    print(df.shape)
    print(df.head())
    df['date'] = pd.to_datetime(df['date'], errors='coerce')
    df['just_date'] = df['date'].dt.date
    df.to_csv('./donaldson_comments.csv')
